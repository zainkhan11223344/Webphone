...
<link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Protest+Guerrilla&family=Reddit+Sans+Condensed:wght@200..900&display=swap" rel="stylesheet">
	...
	<>
		...
		<div id="container">
			...
			<div id="main">
				...
				<!-- Logo -->
				<section id="logo">
					<img id="logo_img" src="images/Commtrunks.png">
				</section>
				<!-- End Logo -->
				...
				<section id="controls">
					...
					<section id="audio_control">
						...
						<button class="button" id="vol_down"><img id="vol_down_icon" src="images/vol-minus.png" alt="register"></button>

					</section>
					<section id="panel">
						<button class="button" id="hangup"><img id="hangup_icon" src="images/wp_hangup.gif" alt="register"></button>
